    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="absolute inset-0" style={animatedGradientStyle}>
        ...
        <div className="absolute inset-0 opacity-50">
          <div className="absolute top-0 left-0 w-72 h-72 bg-purple-600/20 rounded-full blur-3xl animate-bounce" style={{animationDuration: '6s'}}></div>
          <div className="absolute top-1/2 right-0 w-96 h-96 bg-blue-600/20 rounded-full blur-3xl animate-bounce" style={{animationDuration: '8s', animationDelay: '2s'}}></div>
          <div className="absolute bottom-0 left-1/3 w-80 h-80 bg-indigo-600/20 rounded-full blur-3xl animate-bounce" style={{animationDuration: '10s', animationDelay: '4s'}}></div>
        </div>
      </div>
