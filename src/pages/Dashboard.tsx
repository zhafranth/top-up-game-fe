          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Kelola data pengguna platform top-up games Anda.
              </p>
            </div>
            ...
            return (
              <Card key={index} className="p-6 gaming-card">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`p-3 rounded-full bg-secondary ${stat.color}`}
                  >
            ...
            <div className="h-64">
              <svg className="w-full h-full" viewBox="0 0 400 200">
                ...
                <g transform="translate(30, 10)">
                  ...
                  <path
                    d={`M 0 ${160 - revenueData[0].revenue * 3} ${revenueData
                      .map(
                        (point, index) =>
                          `L ${index * 60} ${160 - point.revenue * 3}`
                      )
                      .join(" ")} L ${
                      (revenueData.length - 1) * 60
                    } 160 L 0 160 Z`}
                    fill="url(#gradient)"
                  />
